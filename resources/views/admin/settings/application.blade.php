        ...
        <div class="box box-block bg-white">
            <div class="bd-example bd-example-tabs" role="tabpanel">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " id="social-tab" data-toggle="tab" href="#social" role="tab" aria-controls="social" aria-expanded="false">Social e Apps Links</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " id="socialConfiguration-tab" data-toggle="tab" href="#socialConfiguration" role="tab" aria-controls="socialConfiguration" aria-expanded="false">Login Redes Sociais</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " id="api-tab" data-toggle="tab" href="#api" role="tab" aria-controls="api" aria-expanded="false">Mapa e Facebook Keys</a>
                    </li>
                    <li class="nav-item">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <select class="form-control" id="skin" name="menu_skin" autocomplete="off">
                                                <option value="skin-1" @if(Config::get('constants.menu_skin') == 'skin-1') selected @endif>Roxo</option>
                            ...
                            <div class="col-md-10">
                                <form class="form-horizontal" action="{{ route('admin.settings.store') }}" method="POST" enctype="multipart/form-data" role="form">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <div class="float-xs-left mr-1"><input  @if(config('constants.ride_toll') == 1) checked  @endif  name="ride_toll" type="checkbox" class="js-switch" data-color="#43b968"></div>
                                        </div>
                                    </div>
