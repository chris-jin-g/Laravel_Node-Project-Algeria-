...
@section('title', 'Configs Pagamento ')
                        ...
                        <div class="payment_settings" @if(config('constants.card') == 0) style="display: none;" @endif>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    ...
                                    <option @if(config('constants.stripe_currency') == "BRL") selected @endif value="BRL">BRL</option>
                ...
                <div class="card card-block card-inverse card-primary">
                    <blockquote class="card-blockquote">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-6">
                                <input @if(config('constants.debit_machine') == 1) checked  @endif autocomplete="off" name="debit_machine" id="debit-machine-payments" type="checkbox" class="js-switch" data-color="#43b968">
                            </div>
                        </div>
                    </blockquote>
                ...
                <div class="card card-block card-inverse card-primary">
                    <blockquote class="card-blockquote">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-6">
                                <input @if(config('constants.voucher') == 1) checked  @endif autocomplete="off" name="voucher" id="voucher-payments" type="checkbox" class="js-switch" data-color="#43b968">
                            </div>
                        </div>
                    </blockquote>
                </div><!-- DEBITO NA MÁQUINA-->
...
<!--                <div class="card card-block card-inverse card-primary">
                ...
                <div class="form-group row">
                    <div class="col-xs-4">
                        <a href="{{ URL::previous() }}" class="btn btn-warning btn-block">@lang('admin.back')</a>
                    </div>
