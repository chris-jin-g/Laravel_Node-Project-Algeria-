...
<script src="https://maps.googleapis.com/maps/api/js?key={{ Config::get('constants.map_key') }}&libraries=places&callback=initMap&language=@lang('provider.lang')" async defer></script>
@endsection
