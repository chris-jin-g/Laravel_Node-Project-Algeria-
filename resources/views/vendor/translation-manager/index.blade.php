        ...
        <?php foreach($translations as $key => $translation): ?>
            <tr id="<?= $key ?>">
                ...
                <?php if($deleteEnabled): ?>
                    <td>
                        @if(config("constants.demo_mode') != 1)
                            <a id="remove" href="<?= action('\Barryvdh\TranslationManager\Controller@postDelete', [$group, $key]) ?>" class="delete-key" data-confirm="Are you sure you want to delete the translations for '<?= $key ?>?"><span class="glyphicon glyphicon-trash"></span></a>
                        @endif    
                    </td>
                <?php endif; ?>
            </tr>
