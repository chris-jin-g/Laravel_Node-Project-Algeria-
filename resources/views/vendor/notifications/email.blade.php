...
$style = [
    ...
    'button--green' => 'background-color: #22BC66; color: #fff;',
    'button--red' => 'background-color: #dc4d2f; color: #fff;',
    'button--blue' => 'background-color: #3869D4; color: #fff;',
];
?>
                                                ...
                                                <tr>
                                                    <td style="{{ $fontFamily }}">
                                                        <p style="{{ $style['paragraph-sub'] }}">
                                                            Se você está tendo problemas para clicar no "{{ $actionText }}",
