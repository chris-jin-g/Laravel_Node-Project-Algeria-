...
class ProviderFleetDocumentResource extends Controller
{
    ...
    public function index(Request $request, $provider)
    {
        try {
            ...
            return view('fleet.providers.document.index', compact('Provider', 'ServiceTypes','ProviderService','backurl'));
    ...
    public function store(Request $request, $provider)
    {
        ...
        return redirect()->route('fleet.provider.document.index', $provider)->with('flash_success', trans('admin.provider_msgs.provider_service_update'));
    }
    ...
    public function service_destroy(Request $request, $provider, $id)
    {
        try {
            ...
            return redirect()
                ->route('fleet.provider.document.index', $provider)
                ->with('flash_error', trans('admin.provider_msgs.provider_not_found'));
        }
    }
}
