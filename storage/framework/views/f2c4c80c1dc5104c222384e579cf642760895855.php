...
<html lang="pr-br">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/magnificpopup.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/jquery.mb.YTPlayer.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/typography.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/responsive.css')); ?>">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/png" href="<?php echo e(asset('assets/img/icon/favicon.ico')); ?>">
    </head>
    <body>
        <div id="wrapper">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12  col-md-6 sup-txt"><h2>For Support?     Call Us</h2>
                                <div class="call-num">
                                    <h3 class=""><a href="mailto:<?php echo e(config('constants.contact_email', 'Support@dragon.com')); ?>">
                                    <span class="phone-icon"><i class="fa fa-3x fa-envelope"></i></span>
                                    <?php echo e(config('constants.contact_email', 'test@dragon.com')); ?></a> </h3>
                                </div>
                            </div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row no-margin">
                                <div class="col-md-12 copy">
                                    <p><?php echo e(config('constants.site_copyright', '&copy; '.date('Y').' Thinkin Cab')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p><?php echo e(config('constants.site_title','Thinkin Cab')); ?> está disponível na sua cidade</p>
                    </div>
        ...
        <script src="<?php echo e(asset('assets/js/jquery-3.2.0.min.js')); ?>"></script>
