<?php $__env->startSection('title', 'Heat Map'); ?>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header card-header-primary">
                <h5 class="card-title"><?php echo app('translator')->getFromJson('admin.heatmap.Ride_Heatmap'); ?></h5>
...
<script async src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(config('constants.map_key')); ?>&libraries=visualization"></script>
<script type="text/javascript" src="<?php echo e(asset('main/vendor/heatmap/heatmap.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('main/vendor/heatmap/gmaps-heatmap.js')); ?>"></script>
<script type="text/javascript">
  ...
  function getData() {
      ...
      $.ajax({
          url: "<?php echo e(route('admin.get_heatmap')); ?>",
          type: 'get',
          data: {
          },
