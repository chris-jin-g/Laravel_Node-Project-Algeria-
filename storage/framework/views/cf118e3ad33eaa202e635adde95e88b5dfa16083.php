...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('main/vendor/dropify/dist/css/dropify.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('asets/css/material-dashboard.css?v=2.1.0')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('asets/demo/demo.css')); ?>">
...
<div class="fixed-plugin">
      ...
      <ul class="dropdown-menu">
        ...
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="<?php echo e(asset('/asets/img/sidebar-1.jpg')); ?>" alt="">
          </a>
        </li>
        <li class="active">
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="<?php echo e(asset('/asets/img/sidebar-2.jpg')); ?>" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="<?php echo e(asset('/asets/img/sidebar-3.jpg')); ?>" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="<?php echo e(asset('/asets/img/sidebar-4.jpg')); ?>" alt="">
          </a>
        </li>
   ...
   <script src="<?php echo e(asset('/asets/js/core/popper.min.js')); ?>"></script>
  <script src="<?php echo e(asset('/asets/js/core/bootstrap-material-design.min.js')); ?>"></script>
  ...
  <!-- Chartist JS -->
  <script src="<?php echo e(asset('/asets/js/plugins/chartist.min.js')); ?>"></script>
  <!--  Notifications Plugin    -->
  <script src="<?php echo e(asset('/asets/js/plugins/bootstrap-notify.js')); ?>"></script>
  <!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc -->
  <script src="<?php echo e(asset('/asets/js/material-dashboard.js?v=2.1.0')); ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo e(asset('main/vendor/dropify/dist/js/dropify.js')); ?>"></script>
